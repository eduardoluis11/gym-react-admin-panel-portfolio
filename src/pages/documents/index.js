...
const Index = () => {
  ...
  * */
  ...
  return (
      ...
      *
      * Pondré un botón como en la web app de clientes, en donde podrás hacer clic para ver la lista de archivos que
      * tiene ese documento en general, y puedas hacer clic para ver los archivos subidos para ese documento. Pondré un
      * botón que diga “Ver documento”, y un campo llamado “ver documento” Haré una
      * serie de modificaciones:
      *
      * Primero: voy a crear el enlace con todos los archivos que le pertenecen a ese documento.
      *
      * Segundo: en esa nueva página que crearé con la lista de archivos de ese documento, voy a renderizar exactamente
      * la misma tabla que la lista de documentos firmados y sin firmar de la web app de clientes, y así mostrar el
      * enlace de “Ver archivo”. Así, podré ver cada archivo de ese documento.
      * */
      <>
          ...
          <Container maxWidth="xl">
            ...
            <Box sx={{ mb: 4 }}>
              ...
              >
                ...
                {/* Botón para ir a la página de "Documentos Enviados". Ahi veré cada documento de cada cliente. */}
                <Grid item>
            ...
            <Table>
              ...
              {/* Encabezado con los Títulos de las columnas de la Tabla */}
              <TableHead>
                <TableRow>
                  ...
                  <TableCell style={{ color: 'white' }}>Nombre del Documento</TableCell>

                  {/* Enlace para Ver o Descargar el Documento */}
                  <TableCell style={{ color: 'white' }}>Ver Documento</TableCell>

                  {/* Botón para enviarle a un Cliente el Documento Seleccionado */}
              ...
              <TableBody>
                {documentTypes.map((docType) => (
                  <TableRow key={docType.id}>
                    ...
                    {/* Botón para Ver o Descargar el Documento Seleccionado */}
                    <TableCell style={{ color: 'white' }}>
                        <NextLink href={`/documents/${docType.id}`} passHref>
                          <Button component="a" variant="contained" color="primary">
                            Ver Documento
                          </Button>
                        </NextLink>
